  ...
  static const std::vector<SettingInfo> list = [] {
    std::vector<SettingInfo> settings = {
        ...
        SettingInfo::Enum(StrId::STR_MOSAIC_GROUPING, &CrossPointSettings::mosaicDefaultGrouping,
                          ...
                          StrId::STR_APPS),
        SettingInfo::Enum(StrId::STR_MOSAIC_PICKER_SORT, &CrossPointSettings::mosaicPickerSort,
                          {StrId::STR_SORT_NAME, StrId::STR_SORT_RECENTLY_READ, StrId::STR_SORT_DATE_ADDED},
                          "mosaicPickerSort", StrId::STR_APPS),
        SettingInfo::Toggle(StrId::STR_MOSAIC_PICKER_SORT_REVERSED, &CrossPointSettings::mosaicPickerSortReversed,
                            "mosaicPickerSortReversed", StrId::STR_APPS),
        SettingInfo::Enum(StrId::STR_MOSAIC_SORT, &CrossPointSettings::mosaicDefaultSort,
                          {StrId::STR_SORT_DATE_ADDED, StrId::STR_BY_AUTHOR, StrId::STR_BY_SERIES,
                           StrId::STR_SORT_RECENTLY_READ, StrId::STR_SORT_TITLE},
                          "mosaicDefaultSort", StrId::STR_APPS),
        SettingInfo::Toggle(StrId::STR_MOSAIC_SORT_REVERSED, &CrossPointSettings::mosaicSortReversed,
                            "mosaicSortReversed", StrId::STR_APPS),
        SettingInfo::Enum(StrId::STR_MOSAIC_AUTHOR_DISPLAY, &CrossPointSettings::mosaicAuthorGroupDisplay,
                          {StrId::STR_DISPLAY_LIST, StrId::STR_DISPLAY_GRID}, "mosaicAuthorGroupDisplay",
                          StrId::STR_APPS),
        SettingInfo::Enum(StrId::STR_MOSAIC_SERIES_DISPLAY, &CrossPointSettings::mosaicSeriesGroupDisplay,
                          {StrId::STR_DISPLAY_LIST, StrId::STR_DISPLAY_GRID}, "mosaicSeriesGroupDisplay",
                          StrId::STR_APPS),
